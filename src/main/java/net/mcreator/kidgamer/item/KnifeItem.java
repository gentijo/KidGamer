...
public class KnifeItem extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:knife")
	public static final Item block = null;
	public KnifeItem(KidGamerModElements instance) {
		super(instance, 73);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Slice slice Im a master"));
			}
