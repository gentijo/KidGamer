...
public class PlastickAxeItem extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:plastick_axe")
	public static final Item block = null;
	public PlastickAxeItem(KidGamerModElements instance) {
		super(instance, 98);
	}
