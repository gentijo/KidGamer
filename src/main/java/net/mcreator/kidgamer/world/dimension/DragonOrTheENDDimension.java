...
import net.mcreator.kidgamer.item.DragonOrTheENDItem;
...
public class DragonOrTheENDDimension extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:dragon_or_the_end_portal")
	public static final CustomPortalBlock portal = null;
	public DragonOrTheENDDimension(KidGamerModElements instance) {
		super(instance, 4);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(Blocks.LAPIS_BLOCK).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("kid_gamer:dragon_or_the_end"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("dragon_or_the_end_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("dragon_or_the_end_portal",
					Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
							.setRegistryName("dragon_or_the_end_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new DragonOrTheENDItem().setRegistryName("dragon_or_the_end"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("kid_gamer:dragon_or_the_end"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("kid_gamer:dragon_or_the_end")));
				} else {
					entity.func_242279_ag();
