...
public class InfornoBlockBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:inforno_block")
	public static final Block block = null;
	public InfornoBlockBlock(KidGamerModElements instance) {
		super(instance, 139);
	}
