...
public class DiededflowerBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:diededflower")
	public static final Block block = null;
	public DiededflowerBlock(KidGamerModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("diededflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kid_gamer:diededflower"), configuredFeature);
		}
	}
	@SubscribeEvent
