...
public class DaddustBlockBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:daddust_block")
	public static final Block block = null;
	public DaddustBlockBlock(KidGamerModElements instance) {
		super(instance, 169);
	}
