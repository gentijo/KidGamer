...
public class TomateoplantBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:tomateoplant")
	public static final Block block = null;
	public TomateoplantBlock(KidGamerModElements instance) {
		super(instance, 74);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tomateoplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kid_gamer:tomateoplant"), configuredFeature);
		}
	}
	@SubscribeEvent
