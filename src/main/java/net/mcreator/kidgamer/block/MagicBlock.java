...
public class MagicBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:magic")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("kid_gamer:magic_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public MagicBlock(KidGamerModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("kid_gamer:blocks/portalblock"), new ResourceLocation("kid_gamer:blocks/magicliquid"))
						.luminosity(0).density(1000).viscosity(1000).temperature(300).rarity(Rarity.EPIC)).explosionResistance(100f).canMultiply()
								.tickRate(15).levelDecreasePerBlock(5).slopeFindDistance(5).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("magic");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("magic_flowing");
		elements.blocks
		...
		elements.items.add(() -> new BucketItem(still,
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("It will teleport mobs and freeze players"));
			}
		}.setRegistryName("magic_bucket"));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("magic_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kid_gamer:magic_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
