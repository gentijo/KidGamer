...
public class DrakeseedBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:drakeseed")
	public static final Block block = null;
	public DrakeseedBlock(KidGamerModElements instance) {
		super(instance, 54);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("drakeseed"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kid_gamer:drakeseed"), configuredFeature);
		}
	}
	@SubscribeEvent
