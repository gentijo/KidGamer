...
public class YoutubeoreBlockBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:youtubeore_block")
	public static final Block block = null;
	public YoutubeoreBlockBlock(KidGamerModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("youtubeore_block");
		}
