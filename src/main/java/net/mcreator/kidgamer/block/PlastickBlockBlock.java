...
public class PlastickBlockBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:plastick_block")
	public static final Block block = null;
	public PlastickBlockBlock(KidGamerModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plastick_block");
		}
