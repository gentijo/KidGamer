...
public class DirtliquidBlock extends KidGamerModElements.ModElement {
	@ObjectHolder("kid_gamer:dirtliquid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("kid_gamer:dirtliquid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public DirtliquidBlock(KidGamerModElements instance) {
		super(instance, 17);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("kid_gamer:blocks/noobdrool"), new ResourceLocation("kid_gamer:blocks/dirt12344567890"))
		...
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("dirtliquid");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("dirtliquid_flowing");
		elements.blocks
	...
	public static abstract class CustomFlowingFluid extends ForgeFlowingFluid {
		...
		public Vector3d getFlow(IBlockReader world, BlockPos pos, FluidState fluidstate) {
			return super.getFlow(world, pos, fluidstate).scale(5.5);
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dirtliquid_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("kid_gamer:dirtliquid_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
